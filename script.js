...
const textColorToggle = () => {
  const navigation__linkAboutMe = document.querySelector(
    ".js-navigation__linkAboutMe"
  );
  const navigation__linkHobby = document.querySelector(
    ".js-navigation__linkHobby"
  );
  const navigation__linkMusic = document.querySelector(
    ".js-navigation__linkMusic"
  );
  const navigation__linkPhotography = document.querySelector(
    ".js-navigation__linkPhotography"
  );
  const navigation__linkAirsoft = document.querySelector(
    ".js-navigation__linkAirsoft"
  );
...
const darkElementsBacground = () => {
  ...
  const photographySection__yardPhoto = document.querySelector(
    ".js-photographySection__photo--yardPhoto"
  );
  const photographySection__wheatPhoto = document.querySelector(
    ".js-photographySection__photo--wheatPhoto"
  );
  const photographySection__canalPhoto = document.querySelector(
    ".js-photographySection__photo--canalPhoto"
  );

  body__background.classList.toggle("body__background--dark");
  photographySection__yardPhoto.classList.toggle(
    "photographySection__photo--dark"
  );
  photographySection__wheatPhoto.classList.toggle(
    "photographySection__photo--dark"
  );
  photographySection__canalPhoto.classList.toggle(
    "photographySection__photo--dark"
  );
};
